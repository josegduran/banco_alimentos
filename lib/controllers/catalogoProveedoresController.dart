...
class catalogoProveedoresController {
  ...
  static Future init() async {
    try {
      ...
      _userSheet = await _getWorkSheet(spreadsheet, title: 'catalogo.proveedores');

      final firstRow = Proveedores.getFields();
  ...
  static Future<List<Map<String, dynamic>>> readAllRows() async {
    ...
    final headers = Proveedores.getFields();
